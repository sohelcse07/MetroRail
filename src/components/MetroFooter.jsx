...
const MetroFooter = ({ isTelegramReady, setShowTelegramModal }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-5">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-semibold text-gray-800">MetroRail</span>
            </div>
                ...
                <Tooltip.Provider key={social} delayDuration={100}>
                  <Tooltip.Root>
                    <Tooltip.Trigger asChild>
                      <a href="#" className="p-2 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors" aria-label={social}>
                        <svg className="h-5 w-5 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M22 12a10 10 0 11-20 0 10 10 0 0120 0z" />
                        </svg>
                      </a>
                    </Tooltip.Trigger>
                    <Tooltip.Content side="top" className="bg-gray-800 text-white text-xs px-2 py-1 rounded">
                      {social}
          ...
          {/* Static Quick Links - Desktop */}
          <div className="hidden lg:block space-y-5">
            <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-700">Quick Links</h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  {link.path ? (
          ...
          {/* Contact Info */}
          <div className="space-y-5">
            <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-700">Contact Us</h3>
            <address className="not-italic space-y-4">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+8801824919947" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  8801824919947
                </a>
              </div>
              <div className="flex items-center">
                ...
                <a href="mailto:dhakametro3040@gmail.com" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                  dhakametro3040@gmail.com
                </a>
              </div>
            </address>
          </div>
